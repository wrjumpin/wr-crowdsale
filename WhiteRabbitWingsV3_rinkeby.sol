...
contract CommonTokensale is Connector, Pausable {
    ...
    uint public constant preSaleMinPaymentWei = 0.05 ether;    // Hint: Set to lower amount (ex. 0.001 ETH) for tests.
    uint public constant mainSaleMinPaymentWei = 0.01 ether; // Hint: Set to lower amount (ex. 0.001 ETH) for tests.
    ...
    uint public minCapWei = 200 ether;  // TODO  2m USD. Recalculate based on ETH to USD price at the date of tokensale.
    uint public maxCapWei = 600 ether; // TODO 10m USD. Recalculate based on ETH to USD price at the date of tokensale.
